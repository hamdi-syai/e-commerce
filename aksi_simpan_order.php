...
$qsimpanjual = mysqli_query($koneksi, "insert into pesan (status_pesan, tgl_pesan, nama, alamat, email, no_hp) values ('On Process', '$tgl_skrg', '$nama', '$alamat', '$email', '$nohp')")
...
foreach ($_SESSION['items'] as $idProduk => $val) {
  ...
  mysqli_query($koneksi, "insert into detail_pesan (id_pesan, id_produk, jumlah, harga) values ('$id_pesan', '$produk', '$val','$jumlah_harga')");
}
            ...
            /*$html = '
              ...
              <table border="1">
                ...
                $nohp = $_POST['no_hp'];
                $pesan = 'Terima kasih telah berbelanja di toko kami dengan nomer Transaksi '.$invoiceData[id_pesan].' silahkan melanjutkan ke tahap pembayaran sebesar Rp. '.$_POST['total'].' dan bisa dikirimkan melalui Rekening BCA cirebon dengan nomer rekening 9078796759 atas nama badrun junior, dan harap mengirim bukti pembayaran melau link ini badrunjunior@gmail.com dengan subject nomer Transaksi dengan isi nama dan nomer HP ';
...
//include "pages/main_selesai.php";
      ...
      //if($_POST['finish']){
                      session_destroy();
                      echo 'Terima kasih Anda sudah berbelanja di Toko Online kami berikut ini adalah data yang perlu Anda catat<br>';
