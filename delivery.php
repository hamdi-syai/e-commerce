...
<html>
<head>
<title>Tas Kamera BADRUN JUNIOR</title>
...
<body>
	 ...
	 <div class="header-bottom">
	    <div class="wrap">
			...
			<li><a class="color4" href="#">DSLR</a>
				<div class="megapanel">
						<div class="col1">
							<div class="h_nav">
								<h4>Ransel</h4>
								<ul>
									<li><a href="womens.html">TAS KAMERA BACKPACK BIG POMPJET</a></li>
								</ul>	
							</div>							
						</div>
						<div class="col1">
							<div class="h_nav">
								<h4>Sling Bag</h4>
								<ul>
									<li><a href="womens.html">MOHAN CANVAS CAMERA BAG</a></li>
									<li><a href="womens.html">TOTEMLA CANVASANVAS</a></li>
								</ul>	
							</div>							
						</div>
					  </div>
				</li>				
				<li><a class="color5" href="#">Mirrorless</a>
				<div class="megapanel">
					<div class="col1">
							<div class="h_nav">
								<h4>Ransel</h4>
								<ul>
									<li><a href="mens.html">TAS KAMERA BACKPACK BIG POMPJET</a></li>
								</ul>	
							</div>							
						</div>
						<div class="col1">
							<div class="h_nav">
								<h4>Sling Bag</h4>
								<ul>
									<li><a href="mens.html">MOHAN CANVAS CAMERA BAG</a></li>
									<li><a href="mens.html">TOTEMLA CANVASANVAS</a></li>
								</ul>	
							</div>							
						</div>
					</div>
				</li>
				<li><a class="color6" href="other.html">Other</a>
				<div class="megapanel">
					<div class="col1">
						<div class="h_nav">
							<ul>
								<h4><li><a href="other.html">Polaroid</a></li></h4>
							</ul>
						</div>
					</div>
				</div>
